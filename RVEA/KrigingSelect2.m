function PopNew = KrigingSelect2(PopDec,PopObj,MSE,V,V0,NumV1,delta,mu,theta)
...
% Tian, Ran C;heng, Xingyi Zhang, and Yaochu Jin, PlatEMO: A MATLAB platform
...
% This function is written by Cheng He and Qiqi Liu
    ...
    [NumV2,~] = NoActive2(PopObj,V0);
    [NVa,va]  = NoActive2(PopObj,V);
