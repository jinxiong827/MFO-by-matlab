function [model,centers] = FCMmodel2(Problem,Population,L1,L2)
...
% This function is written by Cheng He
    ...
    PopDec      = cat(1,Population.dec);
    csize       = 1 + ceil((length(Population)-L1)/L2);
    [centers,~] = fcm2(PopDec,csize,[2 NaN 0.05 false]);
    ...
    for i   = 1 : csize
        ...
        PopDec = cat(1,temp.dec);
        PopObj = cat(1,temp.obj);
        for j = 1 : Problem.M
